input = """2911threeninesdvxvheightwobm
    ...
    for string in input:
        ...
        for i, char in enumerate(string):
            try:
                ...
                try:
                    if string[i:i+3] in digits:
                        num1 = digits[string[i:i+3]]
                        break
                    elif string[i:i+4] in digits:
                        num1 = digits[string[i:i+4]]
                        break
                    elif string[i:i+5] in digits:
                        num1 = digits[string[i:i+5]]
                        break
                except IndexError:
                    pass
        for i, char in enumerate(string[::-1]):
            ...
            try:
                ...
                try:
                    if string[j:j+3] in digits:
                        num2 = digits[string[j:j+3]]
                        break
                    elif string[j:j + 4] in digits:
                        num2 = digits[string[j:j + 4]]
                        break
                    elif string[j:j + 5] in digits:
                        num2 = digits[string[j:j + 5]]
                        break
                except IndexError:
                    pass
        print(num1, num2)
