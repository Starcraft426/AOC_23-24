...
Game 100: 2 blue, 12 green; 6 green, 1 red, 12 blue; 1 green, 5 blue, 1 red; 1 red, 12 green, 6 blue; 16 blue, 3 green""".split("\n")
...
def run():
    ...
    for i, elem in enumerate(input):
        ...
        data = elem.split(": ")[-1].split("; ")
        for el in data:
            d = el.split(", ")
            for e in d:
                n = int(e.split(" ")[0])
                if "red" in e and n > maxi["red"]:
                    maxi["red"] = n
                if "blue" in e and n > maxi["blue"]:
                    maxi["blue"] = n
                if "green" in e and n > maxi["green"]:
                    maxi["green"] = n
        if maxi["red"]<=12 and maxi["green"]<=13 and maxi["blue"]<=14:
            print(i, maxi)
            N_tot+= i+1
        N_tot2 += maxi["red"]*maxi["green"]*maxi["blue"]
    print(N_tot)
    print(N_tot2)
